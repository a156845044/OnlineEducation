<%@ Page Title="" Language="C#" MasterPageFile="~/Webs/inc/home.Master" AutoEventWireup="true" CodeBehind="lustrumnormalquery.aspx.cs" Inherits="XiaoWeiOnlineEducation.Webs.site.lustrumnormalquery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TabPage" runat="server">
    <h2 class="about-title about-color am-custom-sm-title">江苏专转本考试（5年制非师范类）可报考院校及专业和录取投档线查询</h2>
